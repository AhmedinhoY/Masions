...
const PredictionForm = () => {
  ...
  return (
    <>
      ...
      <form
        className={`flex flex-col gap-6  bg-white !w-[100%] min-h-[50vh] p-2 rounded-md drop-shadow-xl`}
      ...
      >
        ...
        <Input
          ...
          placeholder={
            'enter a House Size in m² [ e.g. 10000 --> do not use a comma "," ] '
          }
          errorText={
            " Please enter a house size in  m², please do not use a comma"
          }
          onInput={inputHandler}
        />
        ...
        <Input
          ...
          errorText={
            " please enter a zip code, minimum of 3 numbers and maximum 5 numbers "
          }
          onInput={inputHandler}
        />
  ...
  return (
    <>
      <div className="container">
        <section>
          <h1 className="container-header">Al-Muthammen</h1>
          <PredictionForm />
        </section>
      </div>
      <div className="w-[1024px] h-full mx-auto px-16 py-4 my-8 flex flex-col gap-0 ">
        ...
        <p>
          This is a Price esitmator it combines Machine Learning and Deep
          Learning Approaches, designed to estimate house prices in the US.
        </p>

        <p>
          The 3 ML & DL models are trained on a range of $162,755 - $806,130
          please note that, the closer the price to $162,755 the more it is
          prune to the error of ± $75,000.
        </p>

        <p className="">
          <span className=" text-[#113264]"> Again </span> House price estimates
          have a ± $75,000 error margin.
        </p>
